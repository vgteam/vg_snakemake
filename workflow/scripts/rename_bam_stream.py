...
parser.add_argument('-f', help='fasta index listing paths and their length', required=True)
parser.add_argument('-p', help='prefix to remove')
    ...
    if line[0] == '@':
        ...
        if line.startswith('@SQ'):
            ...
            if write_sq:
                ...
                for seqn in slen:
                    print('@SQ\tSN:{}\tLN:{}'.format(seqn, slen[seqn]))
                write_sq = False
            # and skip
            continue
        else:
